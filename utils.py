...
class TextLoader():
    def __init__(self, data_dir, batch_size, seq_length):
        ...
        input_file = os.path.join(data_dir, "string_corpus.txt")
...
# import gensim
# model = gensim.models.Word2Vec.load_word2vec_format(vec, binary=True,encoding="utf8")